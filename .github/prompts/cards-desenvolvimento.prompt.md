...
- `.github/infraestrutura-azure-<nome>.md` — serviços Azure que a feature utiliza
...
Antes de fazer perguntas, verifique se o arquivo `.github/feature-<nome>.md` contém a seção **"Configuração do Projeto"**. Se sim, leia os valores de lá:

- Nome da solution
- Target framework
- Primeira feature do projeto?
- Autenticação JWT configurada?
- Serviços de integração existentes

**Se todas as configurações estiverem no documento**, pule direto para o Passo 3 sem fazer perguntas.

**Se alguma configuração estiver faltando**, pergunte **apenas o que não foi encontrado** usando `vscode_askQuestions`:
...
> - `.github/infraestrutura-azure-<nome>.md` — serviços Azure utilizados
...
- Para cada serviço Azure identificado no `infraestrutura-azure-<nome>.md`, gere um card dedicado para o serviço de integração na camada Infra
